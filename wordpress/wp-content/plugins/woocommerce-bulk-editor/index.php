...
//***
        ...
        add_action('admin_menu', function() {
            add_submenu_page('edit.php?post_type=product', 'BEAR ' . __('Bulk Editor', 'woocommerce-bulk-editor'), 'BEAR ' . __('Bulk Editor', 'woocommerce-bulk-editor'), 'manage_woocommerce', 'woobe', function() {
        ...
        add_action('admin_bar_menu', function($wp_admin_bar) {
            ...
            if ($show) {
                $args = array(
                    'id' => 'woobe-btn',
                    'title' => 'BEAR ' . __('Bulk Editor', 'woocommerce-bulk-editor'),
    ...
    public function ask_favour() {
        ...
        add_action('admin_notices', function() use($slug) {
            ...
            <div class="notice notice-info" id="pn_<?php echo $slug ?>_ask_favour" style="position: relative;">
                <button onclick="javascript: pn_<?php echo $slug ?>_dismiss_review(1); void(0);" title="<?php _e('Later', 'woocommerce-bulk-editor'); ?>" class="notice-dismiss"></button>
                <div id="pn_<?php echo $slug ?>_review_suggestion">
                    <p><?php _e('Hi! Are you enjoying using <i>BEAR - WooCommerce Bulk Editor and Products Manager Professional</i>?', 'woocommerce-bulk-editor'); ?></p>
                    <p><a href="javascript: pn_<?php echo $slug ?>_set_review(1); void(0);"><?php _e('Yes, I love it', 'woocommerce-bulk-editor'); ?></a> 🙂 | <a href="javascript: pn_<?php echo $slug ?>_set_review(0); void(0);"><?php _e('Not really...', 'woocommerce-bulk-editor'); ?></a></p>
                </div>

                <div id="pn_<?php echo $slug ?>_review_yes" style="display: none;">
                    <p><?php printf(__('That\'s awesome! Could you please do us a BIG favor and give it a 5-star rating on %s to help us spread the word and boost our motivation?', 'woocommerce-bulk-editor'), $on) ?></p>
                ...
                <div id="pn_<?php echo $slug ?>_review_no" style="display: none;">
                    <p><?php _e('We are sorry to hear you aren\'t enjoying BEAR. We would love a chance to improve it. Could you take a minute and let us know what we can do better?', 'woocommerce-bulk-editor'); ?></p>
                    <p>
