            ...
            if (isset($_GET['page']) AND $_GET['page'] == 'woobe') {
                ...
                <div id="woobe-rate-alert">
                    ...
                    <table>
                        <tr>
                            <td>
                                <a href="javascript: woobe_manage_alert(0);void(0);" class="button button-large dashicons-before dashicons-clock">&nbsp;<?php echo __('Nope, maybe later!', 'woocommerce-bulk-editor') ?></a>
                            </td>

                            <td>
                                <a href="<?= $link ?>" target="_blank" class="woobe-panel-button dashicons-before dashicons-star-filled">&nbsp;<?php echo __('Ok, you deserve it', 'woocommerce-bulk-editor') ?></a>
                            </td>

                            <td>
                                <a href="javascript: woobe_manage_alert(1);void(0);" class="button button-large dashicons-before dashicons-thumbs-up">&nbsp;<?php echo __('Thank you, I did it!', 'woocommerce-bulk-editor') ?></a>
                            </td>
                        </tr>
                    </table>
