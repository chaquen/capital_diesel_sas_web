 ...
 */
class Pix_Nav_Menu_Walker_Edit extends Walker_Nav_Menu  {
	/**
	...
	function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) {
        ...
        <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
                ...
                <div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
                        ...
                        if($depth == 0) {
                            $checked_mega = $item->mega_menu == 1 ? 'checked' : '';
                            $checked_catalog = $item->catalog == 1 ? 'checked' : '';
                            ?>
                            <p class="field-mega-menu description">
                                <label for="edit-menu-item-mega-menu-<?php echo $item_id; ?>">
                                    <input type="checkbox" id="edit-menu-item-mega-menu-<?php echo $item_id; ?>"
                                           ...
                                           <?php echo esc_attr($checked_mega); ?>/>
                                    <?php _e('Mega Menu'); ?>
                                </label>
                            </p>
                            <p class="field-mega-menu description">
                                <label for="edit-menu-item-catalog-<?php echo $item_id; ?>">
                                    <input type="checkbox" id="edit-menu-item-catalog-<?php echo $item_id; ?>"
                                           class="widefat code edit-menu-item-custom"
                                           name="menu-item-catalog[<?php echo $item_id; ?>]"
                                           <?php echo esc_attr($checked_catalog); ?>/>
                                    <?php _e('Woo Catalog'); ?>
                                </label>
                            </p>
                            <?php
