...
class PixAdminSettingSelect extends PixAdminSetting {
	...
	public function display_setting() {
	    ...
	    if( !isset($this->value) || ($this->blank_option === false && $this->value == '') ) {
	        $this->value = $this->default_value;
        }

		?>

			<select name="<?php echo $this->get_input_name(); ?>" id="<?php echo $this->id; ?>" class="<?php echo esc_attr($this->class); ?>">
