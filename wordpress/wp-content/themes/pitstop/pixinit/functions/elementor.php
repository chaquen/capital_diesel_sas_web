...
class PixTheme_Elementor {
	...
	public function pixtheme_register_widgets() {
		...
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\PixTheme_EL_Pix_Tab_Acc() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\PixTheme_EL_Pix_Special_Offers() );
		\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Elementor\PixTheme_EL_Pix_Video() );
