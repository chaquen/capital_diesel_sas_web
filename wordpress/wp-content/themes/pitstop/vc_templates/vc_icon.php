...
<div
    ...
    <div
        class="vc_icon_element-inner vc_icon_element-color-<?php echo esc_attr( $color ); ?><?php if ( $has_style ): echo ' vc_icon_element-have-style-inner'; endif; ?> vc_icon_element-size-<?php echo esc_attr( $size ); ?> vc_icon_element-style-<?php echo esc_attr( $background_style ); ?> vc_icon_element-background-color-<?php echo esc_attr( $background_color ); ?>"<?php echo wp_kses($style, 'post') ?>><?php echo wp_kses($href_before, 'post') ?><span
            class="vc_icon_element-icon <?php echo esc_attr($iconClass); ?>" <?php echo wp_kses( $color === 'custom' ? 'style="color:' . esc_attr( $custom_color ) . ' !important"' : '', 'post' ); ?>></span><?php echo wp_kses($href_after, 'post') ?><?php
