...
if ( pixtheme_get_option( 'portfolio_settings_related_show', 'off' ) == 'on' ) :
	$pixtheme_portfolio_related_title = pixtheme_get_option( 'portfolio_settings_related_title', esc_html__('Related Posts', 'pitstop' ) );
...
<div class="service-page-footer">
	<div class="container">
        <span><?php previous_post_link( '%link', '<i class="fas fa-arrow-left"></i>'.esc_html__('Previous', 'pitstop'), false, '', 'pix-portfolio-cat'); ?></span>
        ...
        <span class="pix-text-right"><?php next_post_link( '%link', esc_html__('Next', 'pitstop').'<i class="fas fa-arrow-right"></i>', false, '', 'pix-portfolio-cat' ); ?></span>
	</div>
</div>
